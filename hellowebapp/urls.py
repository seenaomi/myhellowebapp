...
# from collection.search_indexes import SearchView
...
urlpatterns = patterns ('',
    ...
    url(r'^accounts/create_post/$',
        'collection.views.create_post',
        name='registration_create_post'),

    # page browse urls
    url(r'^browse/$', RedirectView.as_view(pattern_name='browse')),
    url(r'^browse/title/$', 'collection.views.browse_by_title',
        name='browse'),
    url(r'^browse/title/(?P<initial>[-\w]+)/$', 'collection.views.browse_by_title',
